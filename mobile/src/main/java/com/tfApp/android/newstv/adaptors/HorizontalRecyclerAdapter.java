 ...
 */
public class HorizontalRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements OnLoadingCompletedListener<AssetVideosDataModel> {
    private List<AssetVideosDataModel> mList;
    private OnYoutubeItemSelectionListener onItemSelectionListener;
    public HorizontalRecyclerAdapter(List<AssetVideosDataModel> mSnaps, OnYoutubeItemSelectionListener onItemSelectionListener) {
