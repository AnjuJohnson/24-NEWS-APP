...
public class DrawerAdapter extends RecyclerView.Adapter<DrawerAdapter.ViewHolder> {
    ...
    public void updateLiveData(List<DrawerItem> drawerItems){
    ...
    public void setSelected(int position) {
        ...
        if (listener != null) {
            listener.onItemSelected(position,newChecked.getActionName(),newChecked.getAction());
        }
    }
    ...
    public void setMenu(List<MenuDataModel> menus) {
    }
    ...
    public interface OnItemSelectedListener {
        void onItemSelected(int position, String actionName, String newCheckedAction);
    }
}
